            ...
            <div class="section-py">
                <div class="block-ProductList-1">
                    ...
                    <div class="block-right">
                        ...
                        $category_image = get_field('category_image', 'product-category_' . $term_id);
                        if ($category_image): ?>
                        ...
                        <ul>
                            <?php if ($product_categories && !is_wp_error($product_categories)): ?>
                                <?php foreach ($product_categories as $category): 
                                    $is_active = ($term_id === $category->term_id) || term_is_ancestor_of($category->term_id, $term_id, 'product-category');
